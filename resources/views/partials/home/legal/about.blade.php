<div class="space-y-4 text-sm leading-relaxed text-secondary/80 dark:text-light/80">
    ...
    <p>
        Nous nous appuyons sur un réseau international de numéros virtuels pour vous fournir un numéro temporaire en
        quelques secondes, et affichons chaque prix directement en Francs CFA — sans surprise, sans conversion cachée.
    </p>
    <p>
        Le paiement se fait en Mobile Money (Orange Money, Wave, MTN MoMo, Moov Money) ou par carte bancaire, via notre
